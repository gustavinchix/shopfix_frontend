...
export const CategoryTwo = () => {
	...
	const baseAPIUrl = "https://3000-d1531b8c-11c1-4855-999a-eb2feca6dea5.ws-us02.gitpod.io"; // EL DE PAOLA
	//const baseAPIUrl = "https://3000-e2cdfb92-1e98-40e4-b573-9dfae6e651c6.ws-us02.gitpod.io"; ESTE ES EL QUE ESTA EN MI SERVIDOR
	useEffect(() => {
		obtenerDatos();
	}, []);
	const obtenerDatos = async () => {
		const data = await fetch(`${baseAPIUrl}/productos/categoria/3`);
